...
I design and build distributed backends, AI systems, and realtime services — event-driven, type-safe, and low-latency.
...
- [mrcs.page](https://mrcs.page)
- [Habr](https://habr.com/en/users/nmrcs/)
